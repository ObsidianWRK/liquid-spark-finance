...
export const breakpoints = {
  ...
  tablet: { min: 768, max: 1023, mediaQuery: '(min-width: 768px) and (max-width: 1023px)' },
  desktop: { min: 1024, max: 1439, mediaQuery: '(min-width: 1024px) and (max-width: 1439px)' },
  large: { min: 1440, max: 1919, mediaQuery: '(min-width: 1440px) and (max-width: 1919px)' },
