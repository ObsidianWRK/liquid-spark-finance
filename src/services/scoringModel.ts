import {
  ...
  fetchHealthMetrics,
} from '@/features/biometric-intervention/api/healthKitService';
...
export const calculateFinancialScore = (
  ...
  const emergencyFundMonths =
    monthlySpending > 0 ? totalBalance / monthlySpending : 0;
  ...
  return Math.round(
    spendScore * 0.4 + emergencyScore * 0.3 + savingsScore * 0.3
  );
};
