...
import { vueniPalette, VueniCore } from './vueniPalette';
...
export const generateCSSProperties = () => {
  return {
    ...
    // Variant colors
    '--vueni-eco': vueniPalette.eco,
    '--vueni-wellness': vueniPalette.wellness,
    '--vueni-financial': vueniPalette.financial,
    '--vueni-cosmic-odyssey': VueniCore.primary.cosmicOdyssey,
    '--vueni-blue-oblivion': VueniCore.secondary.blueOblivion,
    '--vueni-eco-rgb': hexToRgb(vueniPalette.eco),
    '--vueni-wellness-rgb': hexToRgb(vueniPalette.wellness),
    '--vueni-financial-rgb': hexToRgb(vueniPalette.financial),
    '--vueni-cosmic-odyssey-rgb': hexToRgb(VueniCore.primary.cosmicOdyssey),
    '--vueni-blue-oblivion-rgb': hexToRgb(VueniCore.secondary.blueOblivion),
  };
};
