...
// UPDATED: New Vueni Brand Color Palette
const colorPalette = {
  primary: '#516AC8', // Sapphire Dust - Vueni primary
  success: '#4ABA70', // Accessible green - keeping for accessibility
  danger: '#D64545', // Accessible red - keeping for accessibility
  warning: '#E3AF64', // Caramel Essence - Vueni accent
  neutral: '#8B8478', // Neutral gray with Vueni undertones
} as const;

// UPDATED: Surface system with Vueni brand colors
const surfaceSystem = {
  background: '#0F1939', // Cosmic Odyssey - Vueni primary dark background
  card: '#1A2547', // Lighter variant of Cosmic Odyssey for cards
  overlay: '#253655', // Even lighter for overlays
  glass: {
    subtle: 'rgba(81, 106, 200, 0.03)', // Sapphire Dust at 3% - subtle glass
    default: 'rgba(81, 106, 200, 0.06)', // Sapphire Dust at 6% - standard glass
    prominent: 'rgba(81, 106, 200, 0.12)', // Sapphire Dust at 12% - strong glass
    border: 'rgba(81, 106, 200, 0.08)', // Sapphire Dust at 8% - glass borders
  },
} as const;
...
const semanticColors = {
  // Primary accent
  accent: colorPalette.warning, // Caramel Essence as accent color
  ...
  // Chart colors (semantic mapping) - UPDATED with Vueni brand
  chart: {
    income: colorPalette.success, // Green for income
    spending: colorPalette.danger, // Red for spending
    savings: colorPalette.primary, // Sapphire Dust for savings
    investments: '#26428B', // Blue Oblivion for investments
    debt: colorPalette.warning, // Caramel Essence for debt
  },
} as const;
...
// UPDATED: Chart & Graph System with Vueni brand colors
const chartSystem = {
  // Vueni-branded chart colors with accessibility maintained
  colors: {
    positive: '#4ABA70', // Accessible green for positive values
    negative: '#D64545', // Accessible red for negative values
    neutral: '#516AC8', // Sapphire Dust for neutral values
    warning: '#E3AF64', // Caramel Essence for warnings

    // Extended palette with Vueni brand influence
    extended: {
      teal: '#64D2FF',
      mint: '#63E6E2',
      pink: '#FF375F',
      yellow: '#FFD60A',
      purple: '#26428B', // Blue Oblivion - Vueni secondary blue
    },
  },
