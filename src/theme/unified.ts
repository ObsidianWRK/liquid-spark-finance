...
import { VueniCore, VueniSemantic, VueniNeutral } from './colors/vueniPalette';

// Base color palette pulled from Vueni design tokens
const colorPalette = {
  ...VueniCore,
...
// Semantic color aliases pulled from Vueni design tokens
const semanticColors = VueniSemantic;
...
// Re-export palette tokens for backward compatibility
export { VueniCore, VueniSemantic, VueniNeutral };
