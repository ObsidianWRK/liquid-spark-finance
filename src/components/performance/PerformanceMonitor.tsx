...
export const PerformanceMonitor = React.memo<PerformanceMonitorProps>(
  ({ enabled = import.meta.env.DEV, position = 'top-right' }) => {
    ...
    useEffect(() => {
      ...
      const componentTimer = setInterval(() => {
        const reactElements = document.querySelectorAll(
          '[data-reactroot], [data-react-class]'
        ).length;
        const estimatedComponents = document.querySelectorAll(
          'div[class*="react"], div[id*="react"]'
        ).length;
    ...
    const performanceScore = useMemo(() => {
      ...
      const renderScore =
        metrics.renderTime < 16
          ? 100
          : Math.max(0, 100 - (metrics.renderTime - 16) * 2);
      const memoryScore =
        metrics.memoryUsage < 50
          ? 100
          : Math.max(0, 100 - (metrics.memoryUsage - 50));
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div
                  ...
                  style={{
                    backgroundColor:
                      getPerformanceColor(performanceScore) + '20',
