...
const TransactionWithScores = ({
  transaction,
  scores,
  currency,
}: TransactionWithScoresProps) => {
    ...
    >
      <div className="transaction-layout">
        ...
        <div className="transaction-amount">
          <p
            className={`transaction-amount-text ${getAmountColor(transaction.amount)}`}
          >
        ...
        <div className="mt-3 pt-3 border-t border-white/10">
          <div className="flex items-center justify-between text-xs">
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <div
                className={`font-medium ${getDeliveryStatusColor(transaction.deliveryStatus)}`}
              >
