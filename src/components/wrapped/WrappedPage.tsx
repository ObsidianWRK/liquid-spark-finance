      ...
      content: (
        <div className="text-center space-y-6">
          ...
          <p className="text-white/70 text-lg">
            Let's look back at your amazing financial year!
          </p>
        </div>
      ),
    },
      ...
      content: (
        <div className="text-center space-y-6">
          ...
          <p className="text-white/70">
            across{' '}
            {wrappedData.topMerchants.reduce((acc, m) => acc + m.visits, 0)}{' '}
            transactions
          </p>
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-lg font-medium text-white">
                  {wrappedData.biggestPurchase.merchant}
                </p>
                <p className="text-white/70">
                  {new Date(
                    wrappedData.biggestPurchase.date
    ...
    },
    {
      ...
      content: (
        <div className="text-center space-y-6">
          ...
          <p className="text-white/70 text-lg">
            Categories where you spent less than last year
          </p>
          ...
          <div className="mt-6 p-4 bg-green-500/20 rounded-lg border border-green-500/30">
            <p className="text-green-400 font-medium">
              You saved an extra $
              {wrappedData.savingsVsPreviousYear.toLocaleString()} compared to
              2023!
            </p>
          </div>
        </div>
      ...
      content: (
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-white/70 text-lg">
              {wrappedData.financialScore >= 8
                ? 'Excellent! 🌟'
                : wrappedData.financialScore >= 6
                  ? 'Good progress! 👍'
                  : 'Keep improving! 💪'}
            </p>
          </div>
          ...
          <GlassCard className="p-4 glass-blue max-w-sm mx-auto">
            <p className="text-white text-sm">
              Based on your saving habits, spending control, and budget
              adherence throughout 2024.
            </p>
          </GlassCard>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="text-center space-y-6">
          ...
          <p className="text-white/70">
            Let your friends see how well you managed your finances in 2024
          </p>
