            ...
            <div className="flex items-center space-x-2">
              <div className="w-16 glass-progress h-2">
                <div
                  ...
                  style={{
                    width: `${formatPercentage(metrics.carbonFootprint)}%`,
                  }}
                />
              </div>
            ...
            <div className="flex items-center space-x-2">
              <div className="w-16 glass-progress h-2">
                <div
                  ...
                  style={{
                    width: `${formatPercentage(metrics.sustainableSpending)}%`,
                  }}
                />
              </div>
              <span className="text-white/60 text-xs">
                {formatPercentage(metrics.sustainableSpending)}%
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-2">
              <div className="w-16 glass-progress h-2">
                <div
                  ...
                  style={{
                    width: `${formatPercentage(metrics.greenTransport)}%`,
                  }}
                />
              </div>
              <span className="text-white/60 text-xs">
                {formatPercentage(metrics.greenTransport)}%
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-2">
              <div className="w-16 glass-progress h-2">
                <div
                  ...
                  style={{
                    width: `${formatPercentage(metrics.renewableEnergy)}%`,
                  }}
                />
              </div>
              <span className="text-white/60 text-xs">
                {formatPercentage(metrics.renewableEnergy)}%
              </span>
            </div>
          </div>
        </div>
...
export default EnhancedEcoScore;
