...
export interface VueniGlassCardProps
...
export const VueniGlassCard = memo(
  forwardRef<HTMLDivElement, VueniGlassCardProps>(
    (
      {
        variant = 'default',
        blur = 'sm',
      ...
      return (
        <Card
          ...
          className={cn(
            ...
            animated &&
              'transition-all duration-300 hover:bg-opacity-30 hover:border-white/30',
            className
          )}
          {...props}
        >
...
export interface VueniButtonProps
...
const buttonVariants = {
  ...
  glass:
    'bg-white/5 hover:bg-white/15 backdrop-blur-sm border-white/10 text-white',
  ...
  enterprise:
    'bg-slate-700/50 hover:bg-slate-600/50 border-slate-600/30 text-slate-200',
};
...
export const VueniButton = memo(
  forwardRef<HTMLButtonElement, VueniButtonProps>(
    (
      {
        variant = 'default',
        size = 'md',
...
export const VueniSkeleton = memo(
  ({ variant = 'text', width, height, className }: VueniSkeletonProps) => {
