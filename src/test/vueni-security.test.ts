...
describe('VueniSessionManager', () => {
  ...
  it('should retrieve current session', () => {
    const originalSession = VueniSessionManager.createSession(
      'user123',
      'test@vueni.com'
    );
...
describe('Security Validation', () => {
  ...
  it('should use secure session IDs', () => {
    const session1 = VueniSessionManager.createSession(
      'user1',
      'user1@vueni.com'
    );
    const session2 = VueniSessionManager.createSession(
      'user2',
      'user2@vueni.com'
    );
