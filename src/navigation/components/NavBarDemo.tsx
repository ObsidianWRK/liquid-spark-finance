      ...
      <div className="px-4 py-8 space-y-8">
        <div className="text-center text-white space-y-4">
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Scroll down to see the navbar hide/reveal behavior. Try the different configurations below.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 space-y-4">
            ...
            <div className="text-sm text-white/70">
              Current active tab: <span className="font-mono text-blue-300">{activeTabId}</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {Array.from({ length: 20 }, (_, i) => (
              ...
              >
                <h3 className="text-white font-semibold mb-2">Content Block {i + 1}</h3>
                <p className="text-white/70">
                  This is sample content to demonstrate the scroll behavior. 
                  Keep scrolling to see the navbar hide and reveal based on scroll direction.
                  The navbar uses CSS transforms for smooth, performant animations.
                </p>
                
                {i === 5 && (
                  <div className="mt-4 p-4 bg-blue-500/20 rounded-lg border border-blue-400/30">
                    <p className="text-blue-200 text-sm">
                      💡 <strong>Tip:</strong> The navbar will hide when scrolling down and reveal when scrolling up,
                      but it always shows when you're near the top of the page.
                    </p>
                  </div>
                )}
                ...
                {i === 10 && (
                  <div className="mt-4 p-4 bg-green-500/20 rounded-lg border border-green-400/30">
                    <p className="text-green-200 text-sm">
                      🎯 <strong>Accessibility:</strong> All buttons have proper ARIA labels, 
                      focus indicators, and meet WCAG touch target size requirements (48px minimum).
                    </p>
                  </div>
                )}
                ...
                {i === 15 && (
                  <div className="mt-4 p-4 bg-purple-500/20 rounded-lg border border-purple-400/30">
                    <p className="text-purple-200 text-sm">
                      📱 <strong>Responsive:</strong> The component adapts to different screen sizes
                      and orientations, hiding certain tabs on mobile and adjusting spacing in landscape mode.
                    </p>
                  </div>
                )}
              </div>
