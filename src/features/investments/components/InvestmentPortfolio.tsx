...
const InvestmentPortfolio = ({
  ...
  const [selectedView, setSelectedView] = useState<
    'overview' | 'holdings' | 'performance' | 'allocation'
  >('overview');
  ...
  const loadPortfolio = async () => {
    try {
      setLoading(true);
      const portfolioData =
        await investmentService.getFamilyPortfolio(familyId);
    ...
    <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-1">
              <p
                className={cn(
                  ...
                  getPerformanceColor(portfolio.totalGainLoss)
                )}
              >
              ...
              <p
                className={cn(
                  'text-xs sm:text-sm',
                  getPerformanceColor(portfolio.totalGainLossPercent)
                )}
              >
      ...
      <div className="bg-white/[0.02] rounded-2xl border border-white/[0.08] p-4 sm:p-6 card-hover">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          {Object.entries(portfolio.performance.returns).map(
            ([period, value]) => (
              <div
                key={period}
        ...
        {Object.keys(portfolio.allocation.sectors).length > 0 && (
          <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-white/[0.08]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
              {Object.entries(portfolio.allocation.sectors).map(
                ([sector, percentage]) => (
                  <div
                    key={sector}
      ...
      <div className="bg-white/[0.02] rounded-2xl border border-white/[0.08] p-4 sm:p-6 card-hover">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white text-xs sm:text-sm font-medium min-w-[3rem]">
                {portfolio.riskMetrics.concentrationRisk.toFixed(1)}%
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white text-xs sm:text-sm font-medium min-w-[3rem]">
                {portfolio.riskMetrics.sectorConcentration.toFixed(1)}%
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-4 sm:mt-6">
          <div className="text-center p-3 bg-white/[0.02] rounded-lg border border-white/[0.05]">
            ...
            <p className="text-sm sm:text-base lg:text-lg font-bold text-red-400 truncate">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          <div className="text-center">
            ...
            <p className="text-blue-400 font-semibold text-xs sm:text-sm">
              {formatCurrency(
                (portfolio.totalValue * portfolio.allocation.stocks) / 100
              )}
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="text-green-400 font-semibold text-xs sm:text-sm">
              {formatCurrency(
                (portfolio.totalValue * portfolio.allocation.bonds) / 100
              )}
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="text-yellow-400 font-semibold text-xs sm:text-sm">
              {formatCurrency(
                (portfolio.totalValue * portfolio.allocation.cash) / 100
              )}
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="text-purple-400 font-semibold text-xs sm:text-sm">
              {formatCurrency(
                (portfolio.totalValue * portfolio.allocation.other) / 100
              )}
            </p>
          </div>
        </div>
                ...
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-white/60 text-xs sm:text-sm">
                        {formatCurrency(
                          (portfolio.totalValue * percentage) / 100
                        )}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between sm:block text-right">
                  <div>
                    ...
                    <p
                      className={cn(
                        'text-xs sm:text-sm',
                        getPerformanceColor(holding.unrealizedGainLoss)
                      )}
                    >
