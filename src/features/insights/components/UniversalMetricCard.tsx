    ...
    const getVariantStyles = () => {
      switch (variant) {
        ...
        case 'financial':
          return {
            container:
              'bg-gradient-to-br from-blue-500/10 to-indigo-500/10 backdrop-blur-md border border-blue-400/20',
        ...
        case 'account':
          return {
            container:
              'bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-md border border-green-400/20',
        ...
        case 'balance':
          return {
            container:
              'bg-gradient-to-br from-purple-500/10 to-violet-500/10 backdrop-blur-md border border-purple-400/20',
        ...
        case 'goal':
          return {
            container:
              'bg-gradient-to-br from-orange-500/10 to-amber-500/10 backdrop-blur-md border border-orange-400/20',
