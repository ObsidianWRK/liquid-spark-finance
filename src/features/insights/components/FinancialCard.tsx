...
const FinancialCard: React.FC<FinancialCardProps> = ({ data }) => {
  ...
  return (
    <div className="w-full">
      {/* Header */}
      <div className="bg-surface-900/70 rounded-2xl border border-slate-700/40 p-4 sm:p-6 mb-4 sm:mb-6 backdrop-blur-md shadow-lg" data-testid="insights-card">
      ...
      {/* Financial Insights */}
      <div className="bg-surface-900/70 rounded-2xl border border-slate-700/40 p-4 sm:p-6 backdrop-blur-md shadow-lg" data-testid="insights-card">
        <h4 className="text-lg sm:text-xl font-bold text-white mb-4">Financial Insights</h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {insights.map((insight, index) => (
            <div key={insight.title} className="p-4 rounded-xl bg-surface-900/50">
