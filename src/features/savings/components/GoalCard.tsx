        ...
        <div className="border-t border-white/[0.06] pt-4">
          {!showContribution ? (
            <button
              ...
              className="w-full py-2 bg-white/[0.05] border border-white/[0.12] rounded-vueni-lg text-white/80 hover:bg-white/[0.08] hover:text-white transition-all text-sm font-medium flex items-center justify-center space-x-2"
            >
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    placeholder="Amount"
                    className="flex-1 bg-white/[0.05] border border-white/[0.12] rounded-vueni-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50"
                  ...
                  <button
                    ...
                    className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-vueni-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
