    ...
    const baseClasses = cn(
      'relative overflow-hidden transition-all duration-300',
      {
        ...
        'bg-gradient-to-br from-green-500/10 to-emerald-600/10 border border-green-500/20':
          variant === 'eco',
        'bg-gradient-to-br from-blue-500/10 to-cyan-600/10 border border-blue-500/20':
          variant === 'wellness',
        'bg-gradient-to-br from-purple-500/10 to-indigo-600/10 border border-purple-500/20':
          variant === 'financial',
