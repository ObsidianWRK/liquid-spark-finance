...
export const UnifiedCard = React.memo<UnifiedCardProps>(
  ({
    ...
    return (
      <div
        className={cn(getCardClasses(variant, size, interactive), className)}
      ...
      >
        ...
        {(metric || delta) && (
          <div className="space-y-2">
            {metric && (
              <p className={unifiedCardTokens.text.metric}>{metric}</p>
            )}
            ...
            {delta && (
              <div
                className={cn(
                  ...
                  unifiedCardTokens.text.delta
                )}
              >
                <span className={getTrendColor()}>{formatDelta()}</span>
                {delta.label && (
