    ...
    const getTrendIcon = () => {
      ...
      switch (direction) {
        case 'up':
          return (
            <ArrowUp
              style={{ color: vueniTheme.colors.palette.success }}
              className="w-4 h-4"
            />
          );
        case 'down':
          return (
            <ArrowDown
              style={{ color: vueniTheme.colors.palette.danger }}
              className="w-4 h-4"
            />
          );
        default:
          return (
            <Minus
              style={{ color: vueniTheme.colors.palette.neutral }}
              className="w-4 h-4"
            />
          );
      }
          ...
          <div className="space-y-2">
            ...
            {delta && (
              <div className="flex items-center gap-2 text-sm">
                ...
                {delta.label && (
                  <span className="text-white/60">{delta.label}</span>
                )}
              </div>
            )}
          </div>
            ...
            <div className="relative h-2 bg-white/[0.05] rounded-vueni-pill overflow-hidden">
              <div
                ...
                style={{
                  ...
                  backgroundColor:
                    progress.color || vueniTheme.colors.palette.primary,
                }}
              />
            </div>
          </div>
