...
test.describe('Adaptive Navigation System', () => {
  ...
  test.describe('Mobile Navigation (Bottom Bar)', () => {
    ...
    test('should display bottom navigation with max 5 items', async ({ page }) => {
    ...
    test('should navigate correctly when bottom nav items are clicked', async ({ page }) => {
      const bottomNav = page.locator('[role="navigation"][aria-label="Bottom navigation"]');
      ...
      const dashboardBtn = bottomNav.locator('button', { hasText: 'Dashboard' });
  ...
  test.describe('Tablet Navigation (Navigation Rail)', () => {
    ...
    test('should display navigation rail in collapsed state by default', async ({ page }) => {
      const navRail = page.locator('[aria-label="Navigation rail"]');
    ...
    test('should navigate correctly when rail items are clicked', async ({ page }) => {
      const navRail = page.locator('[aria-label="Navigation rail"]');
  ...
  test.describe('Responsive Transitions', () => {
    test('should switch navigation correctly when resizing viewport', async ({ page }) => {
      // Start with desktop
      await page.setViewportSize(viewports.desktop);
      await page.goto('/');
  ...
  test.describe('Accessibility', () => {
    test('should have proper ARIA labels across all breakpoints', async ({ page }) => {
