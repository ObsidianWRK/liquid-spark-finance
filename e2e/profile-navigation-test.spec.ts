...
test.describe('Profile Navigation Test', () => {
  test('Back to Dashboard button should be clickable and functional', async ({ page }) => {
    ...
    const backButton = page.locator('button:has-text("Back to Dashboard")').first();
    ...
    const sidebarDashboardButton = page.locator('.lg\\:col-span-1 button:has-text("Dashboard")');
    ...
    const sectionDashboardButton = page.locator('h2:has-text("Preferences")').locator('..').locator('button:has-text("Dashboard")');
