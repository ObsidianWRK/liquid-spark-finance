...
test.describe('Desktop Responsive Navigation Test', () => {
  test('should be fully responsive and navigable on desktop viewports', async ({ page }) => {
  ...
  test('should handle smooth layout transitions across viewport changes', async ({ page }) => {
