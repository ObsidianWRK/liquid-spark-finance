...
test.describe('Financial Calculators E2E Tests', () => {
  ...
  test('should calculate compound interest correctly', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="result"]')).toContainText('13,488');
  ...
  test('should calculate loan payment correctly', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="monthly-payment"]')).toContainText('1,520');
    
    // Verify amortization schedule
    await expect(page.locator('[data-testid="amortization-table"]')).toBeVisible();
  });
  ...
  test('should calculate ROI correctly', async ({ page }) => {
    ...
    // Verify 20% ROI
    await expect(page.locator('[data-testid="roi-percentage"]')).toContainText('20.00%');
    await expect(page.locator('[data-testid="profit-amount"]')).toContainText('$200.00');
  });
  ...
  test('should save and load calculations', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="principal-input"]')).toHaveValue('50000');
  ...
  test('should compare multiple scenarios', async ({ page }) => {
    ...
    const scenario1Result = await page.locator('[data-testid="scenario-1-result"]').textContent();
    const scenario2Result = await page.locator('[data-testid="scenario-2-result"]').textContent();
  ...
  test('should handle currency conversion in calculators', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="rate-history-chart"]')).toBeVisible();
  });
  ...
  test('should validate security measures', async ({ page }) => {
    ...
    // Test XSS prevention
    await page.fill('[data-testid="principal-input"]', '<script>alert("xss")</script>');
  ...
  test('should display help and tooltips', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="tooltip"]')).toContainText('U.S. stock market');
